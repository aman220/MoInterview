      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="text-center space-y-16 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 justify-center pt-8">
            <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground font-light leading-relaxed text-center max-w-3xl">
              PLATFORM IS UNDER CONSTRUCTION
            </p>

            <Link
              href="https://docs.google.com/forms/d/e/1FAIpQLSeXU_aVNn577h_An1a8e7ETFFXlGQ-ej7X5OrDCH7ZqE2KBFw/viewform?usp=publish-editor"
              target="_blank"
